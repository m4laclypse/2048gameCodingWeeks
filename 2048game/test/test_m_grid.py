...
def test_grid_add_new_tile():
    ...
    game_grid=grid_add_new_tile(game_grid,4)
...
def test_get_all_tiles():
    assert grid_get_all_tiles( [[' ',"4","8","2"], [' ',' ',' ',' '], [' ',"512","32","64"], ["1024","2048","512", ' ']]) == ["0","4","8","2","0","0","0","0","0","512","32","64", "1024","2048","512","0"]
    assert grid_get_all_tiles([["16","4","8","2"], ["2","4","2","128"], ["4","512","32","64"], ["1024","2048","512","2"]]) == ["16", "4", "8", "2", "2", "4", "2", "128", "4", "512", "32", "64", "1024", "2048", "512", "2"]
    assert grid_get_all_tiles(create_grid(3))== ["0" for i in range(9)]
...
def test_get_new_position():
    ...
    assert(grid_get_value(grid,x,y)) == " "
